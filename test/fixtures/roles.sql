...
DROP ROLE IF EXISTS postgrest_test_anonymous, postgrest_test_default_role, postgrest_test_author, other_authenticator;
...
CREATE ROLE other_authenticator LOGIN;
